...
class RSVP(models.Model):
    ...
    dietary_requirements_1 = models.ManyToManyField(DietaryRequirement, blank=True, related_name='rsvps_dietary_1')
    ...
    will_attend_2 = models.BooleanField("Are you attending?", default=False, blank=True, null=True)
    dietary_requirements_2 = models.ManyToManyField(DietaryRequirement, blank=True, related_name='rsvps_dietary_2')
    ...
    will_attend_3 = models.BooleanField("Are you attending?", default=False, blank=True, null=True)
    dietary_requirements_3 = models.ManyToManyField(DietaryRequirement, blank=True, related_name='rsvps_dietary_3')
    ...
    will_attend_4 = models.BooleanField("Are you attending?", default=False, blank=True, null=True)
    dietary_requirements_4 = models.ManyToManyField(DietaryRequirement, blank=True, related_name='rsvps_dietary_4')
    ...
    will_attend_5 = models.BooleanField("Are you attending?", default=False, blank=True, null=True)
    dietary_requirements_5 = models.ManyToManyField(DietaryRequirement, blank=True, related_name='rsvps_dietary_5')
